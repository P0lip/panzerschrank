...
export default [
  {
    [Symbol.hasInstance]: instance => instance instanceof WeakMap,
    serializer: weakMap => new ShadowedWeakMap(weakMap),
  },
  {
    [Symbol.hasInstance]: instance => instance instanceof WeakSet,
